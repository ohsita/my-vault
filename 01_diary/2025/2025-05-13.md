...
- [x] Science Document 修正   [scheduled:: 2025-05-12]  [completion:: 2025-10-18]
- [x] 公式LINE投稿内容検討
...
この溶液を3セット用意し、1セットはブランクとし、残り2セットは2地点それぞれで採取したサンプルを分析する。

サイエンスミッションの後は容量10ml以上のプラスチック容器(蓋つき)に移し、段ボールの中に保管し輸送する。